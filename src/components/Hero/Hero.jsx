        ...
        <section className={styles.container}>
            <div className={styles.content}>
                ...
                <p className={styles.description}>Soy programador Fullstack con habilidades en React JS, React Native, Node JS y Adobe Photoshop CS6.
                    Tengo experiencia con JS y React creando varios proyectos personales, y siempre estoy ansioso por aprender nuevas tecnologías. También realicé proyectos en React Native y Node JS.</p>
